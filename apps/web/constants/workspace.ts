...
export const inviteMembersConstants = {
  dialog: {
    ...
    description:
      "Invite people to collaborate on this workspace by email or username.",
    inviteLinkLabel: "Invite Link",
    inviteLinkNote: "Anyone with this link can join the workspace",
    copyLinkSuccess:
      "Invite link copied. Share this link with team members to invite them.",
    ...
    sendButton: (count: number) =>
      `Send ${count > 0 ? count + " " : ""}Invite${count !== 1 ? "s" : ""}`,
