    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Join thousands of teams who trust TeamFlow to deliver exceptional
            project outcomes
          </motion.p>
        </motion.div>
        ...
        >
          {STATISTICS_DATA.map((stat, index) => (
            <motion.div key={stat.id} variants={itemVariants}>
              <Card
                className={`p-8 text-center  border-0 h-full flex flex-col ${stat.bgColor}`}
              >
                <div className="flex justify-center mb-6">
                  <div
                    className={`p-3 rounded-full bg-white dark:bg-card shadow-sm ${stat.iconColor}`}
                  >
